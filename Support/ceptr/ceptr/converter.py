...
class Converter:
    ...
    def writer(self):
        ...
        with open(self.hdrname, "w") as hdr, open(self.cppname, "w") as cpp:
            ...
            cck.temp_given_ey(hdr, self.mechanism, self.species_info.nonqssa_species_list)
            cck.temp_given_hy(hdr, self.mechanism, self.species_info.nonqssa_species_list)
